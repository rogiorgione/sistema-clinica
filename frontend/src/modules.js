export const groups = [
  ...
  { label: 'Marketing & Vendas', items: [['marketing','Marketing'], ['lead-capture','Captação de Leads'], ['commercial','Central Comercial'], ['pipeline','Pipeline'], ['leads','Leads'], ['followup','Follow-up'], ['objections','Objeções'], ['crmCampaigns','Campanhas'], ['commercialReports','Relatórios'], ['commercialDashboard','Dashboard Comercial'], ['campaigns','Campanhas Marketing'], ['crm','CRM'], ['whatsapp','WhatsApp Inteligente'], ['tasks','Tarefas Comerciais'], ['captions','Banco de Legendas'], ['content-calendar','Calendário de Conteúdo'], ['ai-assistant','Assistente IA'], ['reels','Roteiros Reels'], ['stories','Banco de Stories'], ['metrics','Métricas Sociais']] },
...
export function allowed(item, user) {
  ...
  const map = { dentista:['patients','appointments','budgets','documents','implant-crm','financial'], recepcao:['patients','appointments','whatsapp','tasks','notifications','commercial','pipeline','leads','followup'], financeiro:['financial','implant-financial','reports','documents'], marketing:['marketing','lead-capture','commercial','pipeline','leads','followup','objections','crmCampaigns','commercialReports','commercialDashboard','campaigns','crm','whatsapp','captions','content-calendar','ai-assistant','reels','executive','tasks'], leitura:groups.flatMap(g=>g.items.map(i=>i[0])) };
