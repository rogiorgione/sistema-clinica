export const groups = [
  ...
  { label: 'Marketing & Vendas', items: [['marketing','Marketing'], ['lead-capture','Captação de Leads'], ['campaigns','Campanhas'], ['crm','CRM'], ['whatsapp','WhatsApp Inteligente'], ['tasks','Tarefas Comerciais'], ['captions','Banco de Legendas'], ['content-calendar','Calendário de Conteúdo'], ['ai-assistant','Assistente IA'], ['reels','Roteiros Reels'], ['stories','Banco de Stories'], ['metrics','Métricas Sociais']] },
